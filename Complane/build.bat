...
"D:\LLVM\bin\clang++.exe" -c complane_avx2.cpp -o complane_avx2.o -g -Wall -fcolor-diagnostics --target=x86_64-w64-mingw -std=c++1z -I "D:\Github\AmusementClub\vapoursynth-classic\include" -fno-exceptions -mavx2
"D:\LLVM\bin\clang++.exe" -c complane_avx.cpp -o complane_avx.o -g -Wall -fcolor-diagnostics --target=x86_64-w64-mingw -std=c++1z -I "D:\Github\AmusementClub\vapoursynth-classic\include" -fno-exceptions -mavx
